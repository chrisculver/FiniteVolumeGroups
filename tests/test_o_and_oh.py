...
def test_o_characters():
  ...
  elements_of_class = lambda name: list(filter(lambda x: x.conjugacy_class == name, o.elements))
...
def test_oh():
  ...
  class_elems = lambda name : sum(elem.conjugacy_class == name for elem in oh.elements)
...
def test_oh_characters():
  ...
  elements_of_class = lambda name: list(filter(lambda x: x.conjugacy_class == name, oh.elements))
